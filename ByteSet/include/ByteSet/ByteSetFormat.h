...
{
    public:
        ByteSetFormat( const std::string &UIName,
        ...
        inline const std::string &getUIName() const { return m_ui_name; }
        inline const std::string &getHeader() const { return m_header; }
    ...
    protected:
        std::string addHeader(const std::string& val) const;
        std::string removeHeader(const std::string& val) const;
        std::string addExp(const std::string& val) const;
        std::string removeExp(const std::string& val) const;
